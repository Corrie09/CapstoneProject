...
# Make frustration MORE sensitive to show effects better
FRUSTRATION_RHO_THRESHOLD = 0.48  # Increased from 0.45
FRUSTRATION_P_THRESHOLD = 0.32    # Increased from 0.30
...
def choose_effort(rho_hat, p_hat, rating, goal):
    ...
    if frustrated:
        exit_prob = 0.6 * rating  # Increased from 0.5
